...
public abstract class SqlQueries {
    ...
    public static String SELECT_ALL_CUSTOMERS = "select app_user_id, first_name, last_name, amount_of_money from app_user where role='CUSTOMER';";
    public static String SELECT_CUSTOMER_BY_ID = "select app_user_id, email, amount_of_money from app_user where app_user_id=?;";
    public static String UPDATE_DEPOSIT_BY_USER_ID = "update app_user set amount_of_money=100 where app_user_id=?;";
    public static String SELECT_ALL_MASTERS = "select app_user_id, first_name, last_name from app_user where role='MASTER';";
    ...
    public static String SELECT_ALL_ORDERS = "select o.id, o.area, o.offset_data_time, o.order_name, o.order_status, o.price, u.email from orders o left join app_user u on u.app_user_id=master_id;";
